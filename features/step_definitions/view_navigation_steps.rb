Then(/^I see the basic navigation menu$/) do
  within('.navbar') do
    ...
    expect(page).to     have_css("a[href='#{collection_items_path}']")
    ...
    expect(page).to_not have_css("a[href='#{new_collection_item_path}']")
...
Then(/^I see the admin navigation menu$/) do
  within('.navbar') do
    ...
    expect(page).to     have_css("a[href='#{new_page_path}']")
    expect(page).to     have_css("a[href='#{new_resource_path}']")
    expect(page).to     have_css("a[href='#{new_collection_item_path}']")
